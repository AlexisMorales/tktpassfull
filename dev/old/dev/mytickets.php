...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="/css/main.css<?php echo "?r=a".time() ?>">
        <link rel="stylesheet" href="/css/ticket.css<?php echo "?r=a".time() ?>">
    ...
    <body style="overflow-x:hidden;">
        ...
        <nav class="navbar navbar-fixed-top mobile-navbar hidden-md-up<?php echo isset($_SESSION['user']) ? " logged-in" : "" ?>" id="mob-menu">
          ...
          <ul class="nav nav-pills nav-stacked">
            ...
            <li class="nav-item">
              <a class="nav-link"><img src="/img/tickets.svg" class="mobile-nav-icon"> My Tickets <span class="sr-only">(current)</span></a>
            </li>
            ...
            <!--li class="nav-item" style="margin-left: -1rem;">
              <a class="nav-link disabled"><img src="/img/settings.svg" class="mobile-nav-icon"> Settings</a>
            </li-->
						<?php } else { ?>
            <li class="nav-item">
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="nav-item"<?php echo isset($_SESSION['user']) ? '' : ' style="display:none;"' ?>>
                    ...
                    <div id="account-drop" class="dropdown-menu" aria-labelledby="account">
                      <a class="dropdown-item"><img src="/img/tickets.svg" class="account-drop-icon"> My Tickets <span class="sr-only">(current)</span></a>
                      <a class="dropdown-item" href="/myevents"><img src="/img/party.svg?r=001" class="account-drop-icon"> My Events</a>
          ...
          <div class="row">
            <div class="col-md-3 col-lg-2 hidden-sm-down sidebar">
              <ul class="nav nav-sidebar">
                <li class="active"><a><img src="/img/tickets-w.svg" class="nav-sidebar-icon"><br>My Tickets <span class="sr-only">(current)</span></a></li>
                <li><a href="/myevents"><img src="/img/party.svg?r=001" class="nav-sidebar-icon"><br>My Events</a></li>
              </ul>
              <!--ul class="nav nav-sidebar">
...
<div class="tktWrap col-lg-6 %%CLASSES%%">
  ...
  <div class="tkt tktRight">
    <div class="eye"><img src="/img/icon.png"></div>
    <div class="number">
      <h3>%%QUANTITY%%</h3>
      <span>Quantity</span>
    </div>
...
EOF;
        ...
        <script src="/js/mytickets.js<?php if(DEV) echo "?r=a".time() ?>"></script>
        <!--script>
