...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="css/font-awesome.min.css" media="none">
        <link rel="stylesheet" href="css/slick.css" media="none">
        <!--link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.2/css/bootstrap.min.css" integrity="sha384-y3tfxAZXuh4HwSYylfB+J125MxIs6mR5FOHamPBG064zB+AFeWH94NdvaCBm8qnd" crossorigin="anonymous"-->
        <link rel="stylesheet" href="css/bootstrap.min.css" media="none">
        <!--[if lte IE 8]><link rel="stylesheet" href="css/ie8.css"><![endif]-->
        <link rel="stylesheet" href="css/slick-theme.css" media="none">
        <link rel="stylesheet" href="css/animate.css" media="none">
        <link rel="stylesheet" href="css/awesome-bootstrap-checkbox.css" media="none">
        <link rel="stylesheet" href="css/powerange.css" media="none">
        <link rel="stylesheet" href="css/main.css<?php if (DEV) echo "?r=".time();?>" media="none">
...
echo $txt; ?>
      ...
      <div class="section text-center display-table" id="landing" data-anchor="landing">
          <div class="display-tablecell">
            <h2 class="display-3">Enjoy the night.</h2>
      ...
      <div class="section display-table" id="section2" data-anchor="2">
        ...
        <div class="overlay"></div>
          ...
          <div class="icons row">
              <div class="icon-col col-sm-6 col-md-3 col-md-offset-3">
              	<img src="img/tickets.svg" class="icon">
                <p class="icon-caption">Quickly book your tickets.</p>
              </div>
              <div class="icon-col col-sm-6 col-md-3">
              	<img src="img/resell.svg" class="icon" style="margin-top:0.8rem;margin-bottom:1.6rem;">
                <p class="icon-caption">If you can no longer go, one click and we'll resell your ticket!</p>
              </div>
<?php /*              <!--div class="icon-col col-sm-6 col-md-3">
              	<img src="img/creditcard.svg" class="icon">
                <p class="icon-caption">Convenient online payment with NO FEES!</p>
              </div>
              <div class="icon-col col-sm-6 col-md-3">
              	<img src="img/facebook.svg" class="icon fb">
                <p class="icon-caption">See which of your friends are going!</p>
              </div-->  */ ?>
            </div>
        </div>
      </div>
      ...
      <div class="section" id="section1" data-anchor="1">
        <div class="intro">
            ...
            <div id="event-carousel" class="col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3"><?php    
	            $template = <<<EOT
<div class="event" style="background-image: url('img/events/%%ID%%');" data-description="%%DESCRIPTION%%" data-postcode="%%POSTCODE%%" data-price="%%PRICE%%" data-transport="%%TRANSPORT%%" data-fbid="%%FBID%%" id="event-%%ID%%" data-status="%%STATUS%%">
...
EOT;
	            foreach($events as $ev){
					...
					$out = str_replace("%%START%%",date("g:i a, j M",$ev['startTime']),$out);
...
<?php /*          <!--a class="small" href="/legal/privacy-policy" title="" target="_blank">Privacy Policy</a> |
	...
	if (!isset($_SESSION['user'])){
		...
		echo $loginUrl; 
	}?>	" id="fb-login"><img src="https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678128-social-facebook-128.png" style="width: 5rem;height: auto;"></a>
                  </div>
        ...
        <div class="modal fade" id="buyModal">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
									<h5 class="buy-section text-center" disabled="">How many queue jumps do you need?</h5>
							...
							Add transport <i class="fa fa-question-circle" title="More info?" style="cursor: help;"></i>
							</label>
									...
									<fieldset class="form-group animated" style="margin:0">
										<form role="form" id="payment-form">
											<div class="row">
												<div class="col-xs-12">
													<div class="form-group">
														<div class="input-group">
															<span class="input-group-addon" style="border-bottom-right-radius: 0; border-bottom-left-radius: 0; min-width: 43px;">
																<i class="fa fa-phone"></i>
															</span>
															<input type="tel" class="form-control " name="mobNumber" placeholder="Mobile number" autocomplete="cc-number" required="" autofocus="" style="border-bottom-right-radius: 0; border-bottom-left-radius: 0;" id="buy-phone-number" >
														</div>
													</div>
												</div>
											</div>
											<div class="row" style="border-top: 0;">
												<div class="col-xs-12">
													<div class="form-group">
														<div class="input-group">
															<span class="input-group-addon" style="border-radius: 0; border-top: 0;">
																<i class="fa fa-credit-card"></i></span><input type="tel" class="form-control" name="cardNumber" placeholder="Valid Card Number" autocomplete="cc-number" required="" autofocus="" style="border-radius: 0; border-top: 0;">
														</div>
													</div>
												</div>
											</div>
											<div class="">
												<div class="col-xs-3 col-md-3" style="padding: 0;">
													<div class="form-group">
														<input type="text" class="form-control" name="cardExpiryMM" placeholder="MM" autocomplete="cc-exp-mm" maxlength="2" required="" style="border-top-left-radius: 0; border-top-right-radius: 0; border-bottom-right-radius: 0; border-top: 0;">
													</div>
												</div>
												<div class="col-xs-3 col-md-3" style="padding: 0;">
													<div class="form-group">
														<input type="text" class="form-control" name="cardExpiryYY" placeholder="YY" autocomplete="cc-exp-yy" maxlength="2" required="" style="border-radius: 0; border-left: 0; border-top: 0;">
													</div>
												</div>
												<div class="col-xs-6 col-md-6 pull-right" style="padding: 0;margin-bottom: 1rem;">
													<div class="form-group">
														<input type="tel" class="form-control" name="cardCVC" placeholder="CVC" autocomplete="cc-csc" maxlength="3" required="" style="border-top-left-radius: 0;border-top-right-radius: 0;border-bottom-left-radius: 0;border-top: 0;border-left: 0;">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-xs-12 text-center">
													<button class="btn btn-primary btn-lg btn-block" id="buy-book-button" type="button">£<span>6.00</span> - Buy now</button>
													<small style="color: #999999;">+£0.25 card processing fee</small>
												</div>
											</div>
										</form>
									</fieldset>
              ...
              <div class="modal-footer text-center" style="display:none">
                <div id="buy-success" class="alert alert-success" style="display: none;">Thank you for booking with tktpass. We have sent <span class="email" id="email"><?php echo $_SESSION['user']['email'] ?? '' ?></span> an email.<br><small>Please check your junk folder and add us as a safe sender.</small></div>
								<a href="/mytickets" class="btn btn-mytickets" style="display:none">My Tickets</a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="quantity-row">
                  <a id="decrease-sell-quantity" class="buy-icon-button minus"><img class="buy-icon minus" src="img/minus.svg"></a>
                  <h1 id="sell-quantity" class="text-center">1</h1>
                  <a id="increase-sell-quantity" class="buy-icon-button plus"><img class="buy-icon plus" src="img/plus.svg"></a>
                </div>
                <hr>
                ...
                <div class="sell-options">
                  ...
                  <div class="checkbox checkbox-success text-center">
                    ...
                    <small id="sell-option-1-info" style="display:none">When purchased, did the ticket include the £6.00 extra transport option?</small>
                  </div>
                </div>
                <div class="buy-phone">
                  <form>
                    <fieldset class="form-group animated">
                      <input type="text" class="form-control" id="sell-phone-number" placeholder="Mobile number">
                    </fieldset>
                  <form>
                </div>
...
<?php /*		<link href='https://fonts.googleapis.com/css?family=Open+Sans:300,300italic,400,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>  */ ?>
        ...
        <link rel="stylesheet" href="css/main.css<?php if (DEV) echo "?r=".time();?>">
...
<!--        <script src="js/vendor/underscore.min.js"></script> -->
        <script src="js/vendor/powerange.js"></script>
				<script type="text/javascript" src="https://js.stripe.com/v2/"></script>
        <script src="js/main.js<?php if(DEV) echo "?r=".time();?>"></script>
        <!--script>
