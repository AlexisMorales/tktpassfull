...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body>
							...
							<div class="steps">
								<div class="step animated current">
									...
									<div class="sexy-picture">
										...
										<div class="click-div">
											<img src="/img/up-arrow-square.svg?r" class="upload-icon">
								...
								<div id="price-carousel">
									<div class="text-center">
										<div class="benefits-list">
											<ul class="tmm-list">
												<li> <img src="/img/stopwatch.svg"/> Save Time</li>
												<li><img src="/img/increase.svg" style="margin-left: 5px;margin-right: 12px;"/> Sell more tickets</li>
												<li><img src="/img/mobile-qr.svg"/> Scan tickets on the door</li>
												<li><img src="/img/24-hours.svg"/> 24/7 customer support</li>
											</ul>
										</div>
									</div>
									<div>
        ...
        <script src="/js/host.js<?php if(DEV) echo "?t=".time() ?>"></script>
</html>