<?php
	...
	$ev = getEvent($_GET['eId']);
/*	if (!$ev['startTime'] || $ev['startTime'] < time()){
		header('Location: /');
		die();
	}*/
?><!DOCTYPE html>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title><?php echo $ev['title'] ?> | tktpass</title>
        ...
        <link rel="canonical" href="https://tktpass.com/events/<?php echo $_GET['eId'];?>">
        ...
        <meta property="og:url" content="https://tktpass.com/events/<?php echo $_GET['eId'];?>">
        <meta property="og:type" content="website">
        <meta property="og:description" content="<?php echo $ev['description']; ?>">
        <meta property="og:image" content="https://tktpass.com/img/events/<?php echo $_GET['eId']; ?>">
        ...
        <div class="overlay"></div>
          ...
          <div class="icons row">
              ...
              <div class="icon-col col-sm-6 col-md-3">
                ...
                <p class="icon-caption">Convenient online payment</p>
              </div>
              <div class="icon-col col-sm-6 col-md-3">
          ...
          <div class="container-fluid">
            <div class="row">
                <div class="event-info col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3">
                 ...
                 <?php if (time() < $ev['startTime'])  echo '<p class="event-info-buttons text-center">
