...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="css/main.css?t=<?php /*if (DEV)*/ echo time();?>">
      ...
      <div class="section" id="section1" data-anchor="1">
        <div class="intro">
            ...
            <div id="event-carousel" class="col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3"><?php    
              $template = <<<EOT
<div class="event" style="background-image: url('../img/bg.png');"
...
<?php /*                  <!--form class="signup-form">
        ...
        <link rel="stylesheet" href="css/awesome-bootstrap-checkbox.css">
        <link rel="stylesheet" href="css/powerange.css">
        <link rel="stylesheet" href="css/main.css?r=<?php /*if (DEV)*/ echo time();?>"-->
...
<!--        <script src="js/vendor/underscore.min.js"></script> -->
        ...
        <script src="js/main.js?r=<?php /*if (DEV)*/ echo time();?>"></script>
        <!--script>
