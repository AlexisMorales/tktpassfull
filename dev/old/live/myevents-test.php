...
$query = "SELECT * FROM events WHERE id IN (SELECT event_id FROM hosts WHERE user_id = ".$_SESSION['user']['id'].") AND startTime >= (UNIX_TIMESTAMP() - 3600*12) ORDER BY startTime";
    ...
    <body>
        ...
        <nav class="navbar navbar-fixed-top mobile-navbar hidden-md-up<?php echo isset($_SESSION['user']) ? " logged-in" : "" ?>" id="mob-menu">
          ...
          <ul class="nav nav-pills nav-stacked">
            ...
            <li class="nav-item">
              <a class="nav-link" href="mytickets.php"><img src="/old/img/tickets.svg" class="mobile-nav-icon"> My Tickets</a>
            </li>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="nav-item"<?php echo isset($_SESSION['user']) ? '' : ' style="display:none;"' ?>>
                    ...
                    <div id="account-drop" class="dropdown-menu" aria-labelledby="account">
                      <a class="dropdown-item" href="mytickets.php"><img src="/old/img/tickets.svg?r=001" class="account-drop-icon"> My Tickets</a>
